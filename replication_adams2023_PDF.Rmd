...
```{r table1.1, results="asis", include=include_long_tables, eval=include_long_tables}
cat("### Table1.1")
...
table1.1 |>
  report_table() |>
  filter(!grepl("cntryyr|Intercept", Parameter)) |> 
  nice_table(highlight = TRUE, short = TRUE,
             col.format.custom = 2, format.custom = "format3")
...
```{r table2_prep, results="asis"}
############################################
###### CREATING TABLE 2 COLUMNS 3 & 4 ######
############################################
...
tableS2.3 |>
  report_table() |>
  filter(!grepl("countryyear|Intercept", Parameter)) |> 
  nice_table(highlight = TRUE, short = TRUE,
             col.format.custom = 2, format.custom = "format3")
```
...
table.S3 |>
  report_table() |>
  filter(!grepl("country|Intercept", Parameter)) |> 
  nice_table(highlight = TRUE, short = TRUE,
             col.format.custom = 2, format.custom = "format3")
```

```{r tableS3B_prep, results="asis"}
############################################
############ CREATING TABLE S3B ############
############################################
...
# With clustered ses
stargazer(
  type = "latex", table.3B.1, table.3B.2,
  add.lines = list(c("Country-Year Fixed Effects?", "Yes"), 
                   c("Country-Level Clustered SEs?", "Yes")),
...
# With clustered ses
stargazer(
  type = "latex", table.S5.1, table.S5.2,
  add.lines = list(c("Country-Year Fixed Effects?", "Yes"), 
                   c("Country-Level Clustered SEs?", "Yes")),
...
stargazer(
  type = "latex", table.S6.1, table.S6.2, table.S6.3,
  add.lines = list(c("Country-Year Fixed Effects?", "Yes"), 
                   c("Country-Level Clustered SEs?", "Yes")),
...
table.S6.1 |>
  report_table() |>
  filter(!grepl("year|Intercept", Parameter)) |> 
  nice_table(highlight = TRUE, short = TRUE,              
             col.format.custom = 2, format.custom = "format3")
```
...
# With clustered ses
stargazer(
  type = "latex", table.S7.1, table.S7.2,
  add.lines = list(c("Country-Year Fixed Effects?", "Yes"), 
                   c("Country-Level Clustered SEs?", "Yes")),
...
# With clustered SEs
stargazer(
  type = "latex", table.S8A1, table.S8A2,
  add.lines = list(c("Country-Year Fixed Effects?", "Yes"), 
                   c("Country-Level Clustered SEs?", "Yes")),
...
### With clustered SEs
stargazer(
  type = "latex", table.S8B1, table.S8B2,
  add.lines = list(c("Country-Year Fixed Effects?", "Yes"), 
                   c("Country-Level Clustered SEs?", "Yes")),
...
### With clustered SEs
stargazer(
  type = "latex", table.S10.1, table.S10.2,
  add.lines = list(c("Country-Year Fixed Effects?", "Yes"), 
                   c("Country-Level Clustered SEs?", "Yes")),
...
```{r, results="asis"}
# With clustered ses
stargazer(type = "latex", table1.1, table1.2, 
...
stargazer(type = "latex", table1.1_2, table1.2_2, 
          add.lines = list(c("Country-Year Fixed Effects?", "Yes"), 
                           c("Country-Level Clustered SEs?", "Yes")),
...
stargazer(type = "latex", table1.1_3, table1.2_3, 
          add.lines = list(c("Country-Year Fixed Effects?", "Yes"), 
                           c("Country-Level Clustered SEs?", "Yes")),
